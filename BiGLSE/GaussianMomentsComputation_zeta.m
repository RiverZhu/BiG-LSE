function [Zhat, Zvar] = GaussianMomentsComputation_zeta(Y, Phat,Pvar,yy_min, Quantize_bit,Quantize_stepsize,Var, zeta)
    % Code is written by Jianhua Mo
	Mean = 0;
    

    t_lower =  yy_min + Quantize_stepsize*Y + zeta;       % lower threshold
    t_upper =  yy_min + (Y+1)* Quantize_stepsize + zeta;    % upper threshold
