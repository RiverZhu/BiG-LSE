...
w     = zeros(L,1);
C     = zeros(L);
% T     = 200;       % max number of iterations (5000 is very conservative, typically converges in tens of iterations)
mse   = zeros(T,1);
Kt    = zeros(T,1);
t     = 1;
...
out = struct('freqs',th,'amps',w(s),'x_estimate',xr,'x_estimate0',xr0,'noise_var',nu,'iterations',t,'mse',mse,'K',Kt);
